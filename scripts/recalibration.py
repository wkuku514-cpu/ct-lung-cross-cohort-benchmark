...
plt.tight_layout()
plt.savefig(BASE + 'calib_recalibrated.png', dpi=150)
plt.close()
print('已保存 calib_recalibrated.png')
...
plt.tight_layout()
plt.savefig(BASE + 'dca_recalibrated.png', dpi=150)
plt.close()
print('已保存 dca_recalibrated.png')
print('完成')
