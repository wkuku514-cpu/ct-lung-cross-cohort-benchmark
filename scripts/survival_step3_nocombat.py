...
print('feature source (no ComBat):', combat.shape)

clin = combat  # 特征源已是 master_features_clean.csv
...
res_df.to_csv(BASE + 'step3_results_nocombat.csv', index=False)
print('\n已保存 step3_results_nocombat.csv')
