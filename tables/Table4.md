### Table 4. Stability of model components across cohorts.
...
**Note.** Overlap is computed on the components with the largest absolute coefficients in each cohort; 89 components were fitted in each cohort.
